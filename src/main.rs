...
use getit::download::{ftp_download, http_download};
use getit::utils;
...
fn run() -> Fallible<()> {
    let args = clap_app!(getit =>
    (version: crate_version!())
    (author: "Alain Lompo {512032+alainlompo@users.noreply.github.com}")
    ...
    (@arg AGENT: -U --useragent +takes_value "identify as AGENT instead of Getit/VERSION")
